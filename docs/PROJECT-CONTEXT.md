...
| Fan power | Custom female-to-female P4 lead assembled from two modified Akyga `AK-CA-78` 23 cm P4 male-to-female extension cables → Akyga `AK-CA-12` P4/Molex adapter → Akyga `AK-CA-35` Molex/3-pin 12 V adapter → intermediate Noctua Low-Noise Adapter → fan; the harness is custom wiring and requires independent pinout, continuity, polarity, and voltage verification |
